...
A lab exercise on Packet Traffic Exfiltration and Analysis using Packet Sniffer tools like WireShark.
...
1. **Clone the Repository:**
    ```bash
    git clone https://github.com/Los-merengue/Network-Traffic-Flow-with-WireShark-for-Beginners.git
    cd Network-Traffic-Flow-with-WireShark-for-Beginners
    ```
